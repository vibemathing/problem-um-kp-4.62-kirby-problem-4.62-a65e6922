...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.62-kirby-problem-4.62-a65e6922-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.62"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.62-kirby-problem-4.62-a65e6922-v1",
      "problem_contract_sha256": "3612f9f73bdf4c9085544865841fdbcd04483c825803f67ee46b7b64d9be2a2c",
      "problem_id": "problem:um-kp-4.62-kirby-problem-4.62-a65e6922",
      "route_id": "route:um-kp-4.62-kirby-problem-4.62-a65e6922-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.62-kirby-problem-4.62-a65e6922-source-fidelity-01",
      "graph_id": "graph:um-kp-4.62-kirby-problem-4.62-a65e6922-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.62-kirby-problem-4.62-a65e6922-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.62-kirby-problem-4.62-a65e6922-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let X be a smooth, closed, connected, oriented 4-manifold with $b^{+}_{2}(X)$ >1. (a) Does X have Donaldson simple type? (b) Does X have Seiberg–Witten simple type?"
          },
          "statement_sha256": "46de6de6adf3ff4da376bb38b6fc46556fa3f80eb546ce5de603238fe063923a"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.62-kirby-problem-4.62-a65e6922-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.62-kirby-problem-4.62-a65e6922-root",
      "route_id": "route:um-kp-4.62-kirby-problem-4.62-a65e6922-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.62-f7fd8d7a4181",
        "url": "https://www.unsolvedmath.com/problems/KP-4.62"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
